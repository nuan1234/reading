...
public class LazyLists {
    ...
    public static void main(String[] args){
        ...
        LazyList<Integer> numbers=form(2);
        ...
        int four2=primes(numbers).tail().tail().head();
        System.out.println(two2+" "+three2+" "+four2);

        printAll(primes(form(2)));
    }
    ...
    public static LazyList<Integer> form(int n){
        return new LazyList<Integer>(n,()->form(n+1));
    }
